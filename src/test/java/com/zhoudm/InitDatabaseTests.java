...
import com.zhoudm.dao.QuestionDAO;
import com.zhoudm.dao.UserDAO;
import com.zhoudm.model.EntityType;
import com.zhoudm.model.Question;
import com.zhoudm.model.User;
import com.zhoudm.service.FollowService;
import com.zhoudm.service.SensitiveService;
...
public class InitDatabaseTests {
    ...
    public void contextLoads() {
        ...
        for (int i = 0; i < 11; ++i) {
            User user = new User();
            user.setHeadUrl(String.format("http://images.zhoudm.com/head/%dt.png", random.nextInt(1000)));
